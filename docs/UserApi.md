...
api_instance = OnlinePetstore::UserApi.new

body = OnlinePetstore::User.new # User | Created user object
...
body = [OnlinePetstore::User.new] # Array<User> | List of user object
...
body = OnlinePetstore::User.new # User | Updated user object

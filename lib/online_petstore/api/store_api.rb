...
module OnlinePetstore
  class StoreApi
    ...
    def get_order_by_id_with_http_info(order_id, opts = {})
      ...
      if @api_client.config.client_side_validation && order_id > 10
        fail ArgumentError, 'invalid value for "order_id" when calling StoreApi.get_order_by_id, must be smaller than or equal to 10.'
      end
